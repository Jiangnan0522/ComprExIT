...
class ModelArgs:
    ...
    fix_mistral_regex: bool = field(
        default=True,
        metadata={
            "help": "Set True to apply the Transformers tokenizer fix for certain Mistral-family tokenizers "
                    "saved with an incorrect regex pattern (prevents subtle tokenization bugs)."
        },
    )
